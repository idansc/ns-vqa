...
# Use static attribute compositions as object categories (i.e. "blue metal sphere")
# Otherwise, use shape (i.e. "sphere")
__C.CLEVR.COMP_CAT = False
...
# ------------------------------
# Data directory
__C.DATA_DIR = osp.abspath(osp.join(__C.ROOT_DIR, '..', '..', 'data', 'mask_rcnn'))
...
def merge_cfg_from_file(cfg_filename):
    ...
    with open(cfg_filename, 'r') as f:
        yaml_cfg = AttrDict(yaml.load(f, Loader=yaml.Loader))
